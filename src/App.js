...
export default function App() {
    ...
    /*
    * setting the state in the render logic cause the component to render again,
    * however as the component is re-rendered the fetch is executed again,
    * set State renders again.
    * That's why we shouldn't set state in render logic.
    * */
    ...
    // runs first, because appears first in the code.
    // useEffect(function() {
    ...
    // runs first, render logic during rendering before any effect execution
    ...
    useEffect(
        function () {
            ...
            async function fetchMovies() {
                ...
                // setting state is asynchronous, so movies won't be updated immediately.
                // we then have stale state, and empty array in this case.
                //
                // console.log(movies);
...
function MovieList({movies, onSelectMovie}) {
    ...
    return (<ul className="list list-movies">
        {movies?.map((movie) => (// presentational
            <Movie
                movie={movie}
                key={movie.imdbID}
